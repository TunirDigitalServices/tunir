...
const Milestones = [
  {
    ...
    date: "Fev, 2024",
    description: "Grew Sfectonir's social media presence from 500 to over 10,000 followers.",
  ...
  {
  title: "SMARTFARM PROJECT ENHANCEMENT",
  date: "Dec, 2024",
  description: "Developed and enhanced the SmartFarm project for digital agriculture.",
  details: "Integrated smart sensors, data-driven irrigation, and satellite imagery to help farmers optimize resources, increase crop yields, and promote sustainable farming practices."
},
{
  title: "OSS AI CHATBOT",
  date: "Aug, 2025",
  description: "Created an AI chatbot to support plant disease detection and treatment advice.",
  details: "Designed to assist farmers by identifying crop diseases, suggesting solutions, and providing accessible agricultural guidance through a conversational interface."
},
];
...
export default function About() {
  ...
  return (
    <section className="mx-auto xl:container md:container sm:container  lg:pb-48 pb-8" data-aos="fade-left">
