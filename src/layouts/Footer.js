...
const Footer = () => {
  return (
    <footer
      className={`${"  bg-no-repeat bg-bottom bg-cover"} overflow-x-hidden `}
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          ...
          <div class="lg:mx-auto lg:text-left  ">
            <h4 class="text-lg text-gray-900 font-medium mb-7">TUNIR</h4>
          ...
          <div class="lg:mx-auto   lg:text-left  ">
            ...
            <ul class="text-sm  transition-all duration-500">
              <li class="mb-6 text-gray-600">Marketing Strategies</li>
              <li class="mb-6 text-gray-600">Photography</li>
              <li class="mb-6 text-gray-600">Social Media Management</li>
              <li className="text-gray-600">Advertising Campaigns</li>
            </ul>
          </div>
          ...
          <div class="lg:mx-auto lg:text-left  ">
            ...
            <ul class="text-sm  transition-all duration-500">
              <li class="mb-6 text-gray-600">Web Design</li>
              <li class="mb-6 text-gray-600">Website Maintenance</li>
              <li class="mb-6 text-gray-600">Consulting</li>
          ...
          <div class="lg:mx-auto  lg:text-left ">
            ...
            <ul class="text-sm  transition-all duration-500">
              ...
              <li class="mb-6 text-gray-600">Innovation</li>
              <li class="mb-6 text-gray-600">Growth</li>
            </ul>
          </div>
        </div>
